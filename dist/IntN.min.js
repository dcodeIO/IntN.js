...
k,d,e="";0<=b;--b){for(d=this.bytes[b].toString(2);8>d.length;)d="0"+d;e+=d;a&&0<b&&(e+=" ")}this.unsigned&&(e+=a?" U":"U");return e};var p=b.fromInt(2),t=b.fromInt(36);b.fromString=function(a,c,d){"number"===typeof c&&(d=c,c=!1);a=(a+"").toLowerCase();d=d||10;if(2>d||36<d)throw RangeError("radix out of range: "+d+" (2-36)");if("-"===a.charAt(0))return b.fromString(a.substring(1),c,d).negate();"+"===a.charAt(0)&&(a=a.substring(1));if("0"===a||"NaN"===a||"Infinity"===a)return c?b.UZERO:b.ZERO;c=c?
b.UZERO:b.ZERO;for(var e=2===d?function(a){return 1<<a}:Math.pow.bind(Math,d),f=0,k=a.length,h,l;f<k;++f){h=a.charAt(k-f-1);l="0123456789abcdefghijklmnopqrstuvwxyz".indexOf(h);if(0>l||l>d)throw Error("illegal interior character: "+h);c=c.add(b.fromInt(l).multiply(b.fromInt(e(f))))}return c};b.prototype.toString=function(a){a=a||10;b.isIntN(a)||(a=b.valueOf(a));if(a.lessThan(p)||a.greaterThan(t))throw RangeError("radix out of range: "+a.toInt()+" (2-36)");var c=this.unsigned?b.UZERO:b.ZERO;if(this.equals(c))return"0";
if(this.isNegative()){if(this.equals(b.MIN_VALUE)){var c=b.divide(this,a).quotient,d=c.multiply(a).subtract(this);return c.toString(a)+d.toInt().toString(a.toInt())}return"-"+this.negate().toString(a)}var d=this,e=[],f;do f=d.modulo(a),e.unshift("0123456789abcdefghijklmnopqrstuvwxyz".charAt(f.toInt())),d=b.divide(d,a).quotient;while(!d.equals(c));return e.join("")};(function(){var a,c;b["isInt"+l]=b.isIntN;for(a in m.a)if(m.a.hasOwnProperty(a))for(c=0;c<m.a[a].length;++c)b[m.a[a][c]]=b[a];for(a in m.prototype)if(m.prototype.hasOwnProperty(a))for(c=
0;c<m.prototype[a].length;++c)b.prototype[m.prototype[a][c]]=b.prototype[a]})();return b}var s=[1,256,65536,16777216,4294967296,1099511627776,281474976710656],m={a:{},prototype:{compare:["comp"],equals:["eq","equal","=="],notEquals:["ne","notEqual","!="],lessThan:["lt","less","lesser","<"],lessThanEqual:["lte","lessThanOrEqual","<="],greaterThan:["gt","greater",">"],greaterThanEqual:["gte","greaterThanOrEqual",">="],not:["~"],and:["&"],or:["|"],xor:["^"],shiftLeft:["lsh","leftShift","<<"],shiftRight:["rsh",
"rightShift",">>"],shiftRightUnsigned:["rshu","rightShiftUnsigned",">>>"],add:["plus","+"],negate:["neg","!"],subtract:["sub","minus","-"],absolute:["abs","||"],multiply:["mult","*"],divide:["div","/"],modulo:["mod","%"]}};"undefined"!==typeof module&&module.exports?module.exports=n:"function"===typeof define&&define.amd?define(function(){return n}):(p.dcodeIO=p.dcodeIO||{}).IntN=n})(this);
